...
const FlightSummary = ({ handleProceed }: { handleProceed: () => void }): JSX.Element | null => {
  ...
  const hasFlight =
    singleFlight.departureTime || singleReturnFlight.departureTime;
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white shadow-lg py-4 md:px-6 px-2 flex justify-between">
      <div className="flex space-x-10 max-sm:space-x-2">
        ...
        {singleReturnFlight.departureTime && (
          <div>
